<div class="form-group mb-3">
    ...
    <div>
        {{ Form::select('alumno_id', $alumnos, $tiposAprendizaje3->alumno_id ?? null, [
...
<div class="form-footer">
    <div class="text-end">
        <div class="d-flex">
            <a href="{{ route('tipos-aprendizaje3s.index') }}" class="btn btn-danger">Cancelar</a>
