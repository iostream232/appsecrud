        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('tipos-aprendizaje2s.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive min-vh-100">
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                @forelse ($tiposAprendizaje2s as $tiposAprendizaje2)
                                    <tr>
                                        <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                   aria-label="Select tiposAprendizaje2"></td>
                                        <td>{{ ++$i }}</td>
                                        
											<td>{{ $tiposAprendizaje2->nombre }}</td>
											<td>{{ $tiposAprendizaje2->estilo }}</td>
											<td>{{ $tiposAprendizaje2->ritmo }}</td>
											<td>{{ $tiposAprendizaje2->alumno_id }}</td>
                                            <td class=" {{ $tiposAprendizaje2->ritmo === 'rapido' ? 'bg-success text-white' : '' }}
                                                        {{ $tiposAprendizaje2->ritmo === 'moderado' ? 'bg-warning text-dark' : '' }}
                                                        {{ $tiposAprendizaje2->ritmo === 'lento' ? 'bg-danger text-white' : '' }}">
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $tiposAprendizaje2s->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
